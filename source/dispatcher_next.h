...
class DispatcherNextBase : public DispatcherBase {
 public:
  virtual ~DispatcherNextBase();
...
class DispatcherNext : public DispatcherNextBase, public Singleton<Derived> {
